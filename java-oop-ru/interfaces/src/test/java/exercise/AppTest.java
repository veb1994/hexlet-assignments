...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        String actualToString = text.toString(); // "fedcba"
        char actualChar = text.charAt(1); // 'e'
        int actualLength = text.length(); // 6
        String actualSubSequence = text.subSequence(1, 4).toString(); // "edc"
        assertThat(actualToString).isEqualTo("fedcba");
